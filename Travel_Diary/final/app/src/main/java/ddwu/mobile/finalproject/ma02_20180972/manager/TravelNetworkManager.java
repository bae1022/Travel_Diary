package ddwu.mobile.finalproject.ma02_20180972.manager;
...
public class TravelNetworkManager {
    private final String TAG = "TravelNetworkManager";

    private Context context;

    public TravelNetworkManager(Context context) {
